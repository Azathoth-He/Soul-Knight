...
bool StartGame::init()
{
	...
	else
	{
		...
		float y = visibleSize.height - 353.0;
	...
	{
		float x = visibleSize.width / 2;
		float y = visibleSize.height - 484.0;
	...
	musicMenu->setPosition(Vec2(1221.0, visibleSize.height - 580.5));
	...
	_factory->loadDragonBonesData("hero_enemy/Archer/Archer_ske.dbbin");
	_factory->loadTextureAtlasData("hero_enemy/Archer/Archer_tex.json");
	_factory->loadDragonBonesData("hero_enemy/Berserker/Berserker_ske.dbbin");
	_factory->loadTextureAtlasData("hero_enemy/Berserker/Berserker_tex.json");
	_factory->loadDragonBonesData("hero_enemy/Paladin/Paladin_ske.dbbin");
	_factory->loadTextureAtlasData("hero_enemy/Paladin/Paladin_tex.json");
...
{
	auto nextScene = ChooseHero::create(3000);
