...
bool StartGame::init()
{
	...
	MenuItemImage* startMenu = MenuItemImage::create(
		"pictures/StartGame/Start.png",
		"pictures/StartGame/Start1.png",
	...
	MenuItemImage* endMenu = MenuItemImage::create(
		"pictures/StartGame/End.png",
		"pictures/StartGame/End1.png",
	...
	auto offMusic = MenuItemImage::create("pictures/StartGame/stopMusic.png", "pictures/StartGame/stopMusic.png");
	auto onMusic = MenuItemImage::create("pictures/StartGame/continueMusic.png", "pictures/StartGame/continueMusic.png");
	...
	//background
	auto background = Sprite::create("pictures/StartGame/background.png");
...
{
	auto nextScene = ChooseHero::create();
